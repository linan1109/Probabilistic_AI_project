...
class Agent:
    ...
    def train_agent(self):
        ...
        for i in range(50):
            ...
            Q_prime_1 = self._critic_1._target_net(torch.cat((s_prime_batch, self._actor._target_net(s_prime_batch)), dim=1))
            Q_prime_2 = self._critic_2._target_net(torch.cat((s_prime_batch, self._actor._target_net(s_prime_batch)), dim=1))
